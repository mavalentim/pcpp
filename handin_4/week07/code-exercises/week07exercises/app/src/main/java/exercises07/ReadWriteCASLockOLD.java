 ...
 * 
 * if (!(holder.get() instanceof Writer)) { // if didnt get the lock cause
 * theres a writer, quit, if because theres a
 * // reader dont quit
 ...
 * Holders currentHolder = holder.get(); // idk if its another reader holding
 * this
